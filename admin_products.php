...
if(isset($_POST['add_product'])){
    ...
    if($select_products->rowCount() > 0){
       ...
       $insert_products = $conn->prepare("INSERT INTO `products`(name, category, details, qty, price, image) VALUES(?,?,?,?,?,?)");
       $insert_products->execute([$name, $category, $details,$qty, $price, $image]);
...
<section class="add-products">
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      <div class="flex">
         ...
         <input type="number" name="qty" class="box" required placeholder="Quantity">
         </div>
         <div class="inputBox">
...
<section class="show-products">
   ...
   <div class="box">
      ...
      <div class="qty">Available:-<?= $fetch_products['qty']; ?></div>
      <div class="flex-btn">
